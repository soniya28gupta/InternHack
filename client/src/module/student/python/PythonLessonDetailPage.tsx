...
import type { PythonProgress, PracticeExercise } from "./data/types";
import { pythonEngine } from "./lib/python-engine";
import type { PyRunResult } from "./lib/python-engine";
...
export default function PythonLessonDetailPage() {
  ...
  const handleToggleComplete = useCallback(() => {
    ...
    if (newVal && isAuthenticated && sectionSlug) {
      ...
      if (allDone) reportMilestone("COURSE_COMPLETE", "python");
    }
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-8 py-8">
        ...
        >
          <div className="flex items-center gap-2 mb-2">
            <div className="h-1 w-1 bg-lime-400"></div>
            <span className="text-[10px] font-mono uppercase tracking-widest text-stone-500 dark:text-stone-400">
              python / section {sectionNum} / lesson {lessonNum}
            </span>
          </div>
