...
import type { BlockchainProgress } from "./data/types";
...
export default function BlockchainSectionPage() {
  ...
  const progress: BlockchainProgress = getLocalProgress();
...
// ✅ early returns AFTER all hooks
  ...
  return (
    <div className="bg-stone-50 dark:bg-stone-950 min-h-[calc(100vh-4rem)]">
      <SEO
        title={`${section.title}, Blockchain Tutorial`}
        description={`Learn ${section.title} in Blockchain. ${section.description}`}
        keywords={`${section.title}, blockchain, tutorial`}
        canonicalUrl={canonicalUrl(`/learn/blockchain/${sectionSlug}`)}
      />
